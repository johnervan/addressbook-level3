...
public class LogicTest {
    ...
    public void constructor() {
        // Constructor is called in the setup() method which executes before
        // every test, no need to call it here again.
     ...
     * also confirms that the following three parts of the Logic object's state
     * are as expected:<br>
     ...
     * <br>
     */
    private void assertCommandBehavior(String inputCommand, String expectedMessage, AddressBook expectedAddressBook,
            boolean isRelevantPersonsExpected, List<? extends ReadOnlyPerson> lastShownList) throws Exception {
        ...
        //Only run the following test if command type mutates the address book
    ...
    public void execute_clear() throws Exception {
        ...
        assertCommandBehavior("clear", ClearCommand.MESSAGE_SUCCESS, AddressBook.empty(), false,
    ...
    public void execute_add_successful() throws Exception {
        ...
        assertCommandBehavior(helper.generateAddCommand(toBeAdded),
                String.format(AddCommand.MESSAGE_SUCCESS, toBeAdded), expectedAB, false, Collections.emptyList());
    ...
    public void execute_addDuplicate_notAllowed() throws Exception {
        ...
        addressBook.addPerson(toBeAdded); // person already in internal address
                                          // book

        // execute command and verify result
        assertCommandBehavior(helper.generateAddCommand(toBeAdded), AddCommand.MESSAGE_DUPLICATE_PERSON, expectedAB,
    ...
    public void execute_list_showsAllPersons() throws Exception {
        ...
        assertCommandBehavior("list", Command.getMessageForPersonListShownSummary(expectedList), expectedAB, true,
                expectedList);
    }
     ...
     * command targeting a single person in the last shown list, using visible
     * index.
     * 
     * @param commandWord
    ...
    public void execute_view_onlyShowsNonPrivate() throws Exception {
        ...
        assertCommandBehavior("view 1",
                String.format(ViewCommand.MESSAGE_VIEW_PERSON_DETAILS, p1.getAsTextHidePrivate()), expectedAB, false,
                lastShownList);

        assertCommandBehavior("view 2",
                String.format(ViewCommand.MESSAGE_VIEW_PERSON_DETAILS, p2.getAsTextHidePrivate()), expectedAB, false,
                lastShownList);
    }
    ...
    public void execute_tryToViewMissingPerson_errorMessage() throws Exception {
        ...
        assertCommandBehavior("view 1", Messages.MESSAGE_PERSON_NOT_IN_ADDRESSBOOK, expectedAB, false, lastShownList);
    }
    ...
    public void execute_viewAll_alsoShowsPrivate() throws Exception {
        ...
        assertCommandBehavior("viewall 1",
                String.format(ViewCommand.MESSAGE_VIEW_PERSON_DETAILS, p1.getAsTextShowAll()), expectedAB, false,
                lastShownList);

        assertCommandBehavior("viewall 2",
                String.format(ViewCommand.MESSAGE_VIEW_PERSON_DETAILS, p2.getAsTextShowAll()), expectedAB, false,
                lastShownList);
    }
    ...
    public void execute_tryToViewAllPersonMissingInAddressBook_errorMessage() throws Exception {
        ...
        assertCommandBehavior("viewall 2", Messages.MESSAGE_PERSON_NOT_IN_ADDRESSBOOK, expectedAB, false,
                lastShownList);
    }
    ...
    public void execute_delete_removesCorrectPerson() throws Exception {
        ...
        assertCommandBehavior("delete 2", String.format(DeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS, p2), expectedAB,
                false, threePersons);
    }
    ...
    public void execute_delete_missingInAddressBook() throws Exception {
        ...
        assertCommandBehavior("delete 2", Messages.MESSAGE_PERSON_NOT_IN_ADDRESSBOOK, expectedAB, false, threePersons);
    }
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        ...
        assertCommandBehavior("find KEY", Command.getMessageForPersonListShownSummary(expectedList), expectedAB, true,
                expectedList);
    }
    ...
    class TestDataHelper {
         ...
         * @param isAllFieldsPrivate
         *            determines if private-able fields (phone, email, address)
         *            will be private
         */
        Person generatePerson(int seed, boolean isAllFieldsPrivate) throws Exception {
            return new Person(new Name("Person " + seed), new Phone("" + Math.abs(seed), isAllFieldsPrivate),
                    new Email(seed + "@email", isAllFieldsPrivate), new Address("House of " + seed, isAllFieldsPrivate),
         ...
         * 
         * @param isPrivateStatuses
         *            flags to indicate if all contact details of respective
         *            persons should be set to private.
         */
        ...
        Person generatePersonWithName(String name) throws Exception {
            return new Person(new Name(name), new Phone("1", false), new Email("1@email", false),
                    new Address("House of 1", false), new UniqueTagList(new Tag("tag")));
        }
    }
